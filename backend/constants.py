...
ANAF_BATCH_SIZE = 100               # CUI-uri per request ANAF
ANAF_CHUNK_SIZE = 10000             # ID-uri încărcate din DB odată
ANAF_RATE_LIMIT_SECONDS = 3.0
ANAF_TIMEOUT_SECONDS = 120
ANAF_RETRY_DELAYS = [30, 90, 180]
ANAF_PAUSE_AFTER_FAILS = 300
